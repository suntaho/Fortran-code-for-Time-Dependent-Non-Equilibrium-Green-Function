module sys_setup
  ...
  subroutine read_t0(GF)
    ...
    if(cv_model) then
        ...
        close(411)
        ! for diagonal rho
        allocate(GF%rhot0(ndim1),GF%rhoti(ndim1),GF%rhotj(ndim1),GF%rhotk(ndim1))
        do i=1,ndim1
            GF%rhot0(i)=0.0
            GF%rhoti(i)=0.0
            GF%rhotj(i)=0.0
  ...
  subroutine free_array(GF)
    ...
    if(cv_model) then 
        ...
        deallocate(GF%rhot0,GF%rhoti,GF%rhotj,GF%rhotk)
    end if
